...
const SVGComponent = ({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) => {
  ...
  const strokeWidth = useTransform(scrollYProgress, [0,1], [4, 0])

  return (
    <motion.svg
      style={{ opacity, translateY }}
      className="w-full fixed top-1/4 left-0 h-full pointer-events-none overflow-hidden"
      viewBox="-10 -10 576 317"
      fill="none"
